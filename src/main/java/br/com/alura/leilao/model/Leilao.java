...
public class Leilao {
	...
	public boolean propoe(Lance lanceAtual) {
		...
		final boolean valido = nonNull(lanceAtual) &&
							   ehUmValorValido(lanceAtual) &&
							   (this.estaSemLances() || ehUmLanceValido(lanceAtual));
	...
	private boolean ehUmValorValido(Lance lance) {
